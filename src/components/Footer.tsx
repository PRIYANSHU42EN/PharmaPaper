...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-[#222222] bg-[#171717]/80 backdrop-blur-sm py-12 mt-20 relative z-50 overflow-hidden">
      <div className="absolute top-0 left-1/4 right-1/4 h-[1px] bg-gradient-to-r from-transparent via-[#888888]/20 to-transparent" />
      ...
      <div className="max-w-6xl mx-auto px-6 flex flex-col items-center gap-6 relative z-10">
        ...
        {/* Legal Policy Links */}
        <div className="flex flex-wrap gap-6 justify-center text-xs text-white/40 border-t border-[#222222]/30 pt-6 w-full max-w-2xl">
